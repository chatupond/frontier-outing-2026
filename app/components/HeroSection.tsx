  ...
  return (
    <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
        ...
        <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold leading-tight mb-6 drop-shadow-lg">
          {"Frontier's Outing"}
          <span className="block text-amber-300">2026</span>
        </h1>
        <p className="text-xl sm:text-2xl text-white/85 font-light max-w-2xl mx-auto leading-relaxed drop-shadow">
          Team outing getaway together &lt;3{" "}
