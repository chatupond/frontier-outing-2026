...
export default function LunchSection() {
  return (
    <section className="flex flex-col md:flex-row min-h-[600px]">
      ...
      {/* Right — info */}
      <div className="w-full md:w-1/2 bg-stone-50 flex items-center">
        <div className="px-10 py-16 md:px-16 max-w-xl">
          ...
          <p className="text-2xl text-amber-700 font-medium mb-6">ครัวน้ำตก</p>
          ...
          <p className="text-gray-400 text-xs font-semibold tracking-widest uppercase mb-3">Menu</p>
          <ul className="grid grid-cols-2 gap-x-6 gap-y-2 mb-10 text-gray-700 text-sm">
            {[
              "แกงคั่วหอยขม",
              "ต้มยำปลาคัง",
              "หน่อไม้ฝรั่งผัดกุ้ง",
          ...
          <div className="flex flex-wrap gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-amber-500 hover:bg-amber-600 transition-colors text-white text-sm font-medium"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-gray-300 hover:border-orange-500 hover:text-orange-600 transition-colors text-gray-700 text-sm font-medium"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
