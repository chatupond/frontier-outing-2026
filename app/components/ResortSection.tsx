    ...
    <section className="flex flex-col md:flex-row min-h-[600px]">
      ...
      <div className="w-full md:w-1/2 bg-white flex items-center">
        <div className="px-10 py-16 md:px-16 max-w-xl">
          ...
          <p className="text-2xl text-amber-700 font-medium mb-6">ธันน์</p>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-gray-300 hover:border-blue-500 hover:text-blue-600 transition-colors text-gray-700 text-sm font-medium"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
